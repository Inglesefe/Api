...
namespace Api.Controllers.Config
{
    ...
    public class IncomeTypeController : ControllerBase<IncomeType>
    {
        ...
        public IncomeTypeController(IConfiguration configuration, IBusiness<IncomeType> business, IPersistentBase<LogComponent> log, IBusiness<Template> templateError) : base(
                  configuration,
                  business,
                  log,
                  templateError)
