...
namespace Api.Controllers.Config
{
    ...
    public class ParameterController : ControllerBase<Parameter>
    {
        ...
        public ParameterController(IConfiguration configuration, IBusiness<Parameter> business, IPersistentBase<LogComponent> log, IBusiness<Template> templateError, IDbConnection connection) : base(
                  configuration,
                  business,
                  log,
                  templateError,
